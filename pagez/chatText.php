...
while($row = $result4->fetch_assoc()){
	...
	if($row['enters'] == 'Y'){
		...
		echo "<span style='background-color:".$row5['color'].";'>o^L^o</span> ".$row5['name']." has entered the lobby :)<br/>";
		
	} else {
		
		echo "<span style='background-color:".$row5['color'].";'>o^L^o</span> ".$row5['name'].": ".$row['message']."<br/>";
	}
}
?>
